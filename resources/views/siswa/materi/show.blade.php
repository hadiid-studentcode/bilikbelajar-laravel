    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <main>
            ...
            <section class="resource-tabs">
                <div class="container">
                    ...
                    <div class="tab-content" id="resourceTabContent">
                        @if ($materi->video)
                            @if (Storage::disk('public')->exists($materi->video))
                            ...
                            @elseif(filter_var($materi->video, FILTER_VALIDATE_URL) && str_contains($materi->video, 'youtube.com'))
                                <div class="tab-pane fade show active" id="video-content">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="card shadow-sm">
            ...
            <div class="floating-nav">
                ...
                <button class="btn btn-primary rounded-circle mb-2 d-none" id="toggleMusic" title="Toggle Music">
                    <i class='bx bx-volume-full'></i>
                </button>
                <a href="{{ route('siswa.dashboard.index') }}" class="btn btn-primary rounded-circle mb-2"
